...
?>
     <div class="ser_div2">
        <a href="index.php">HOME</a><i class="fa fa-arrow-right"></i><?php echo $spec ?>
    </div>
    <div class="ser_div3">
        ...
        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
            <select name="location" id="location" onchange="change_loc()">
                ...
                <?php 
                     $stmt =$conn->query("SELECT location,type FROM ((company INNER JOIN location ON company.com_location=location.id_location) INNER JOIN speciality ON company.com_speciality=speciality.spec_id)");
    ...
    <section>
        <div class="body_div3">
            <?php
                 $stmt2 =$conn->query("SELECT id,name,com_image,type,location FROM ((company INNER JOIN location ON company.com_location=location.id_location) INNER JOIN speciality ON company.com_speciality=speciality.spec_id)"); 
